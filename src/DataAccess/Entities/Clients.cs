...
public partial class Clients
{
    ...
    public int InstallationID { get; set; }   // NOT NULL

    public int LicenseID { get; set; }        // NOT NULL

    public string? MicrosoftID { get; set; }  // VARCHAR NULL

    public string LastAccessed { get; set; } = string.Empty; // NOT NULL (varchar(16))
    public string Created { get; set; } = string.Empty;      // NOT NULL (varchar(16))
